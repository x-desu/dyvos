...
const Footer = () => {
  return (
    ...
    <div className="px-4 py-16 sm:px-6 lg:col-span-3 lg:px-8 max-w-full sm:max-w-screen-sm md:max-w-screen-md lg:max-w-screen-lg xl:max-w-screen-xl mx-auto">
      ...
      <div className="mt-12 border-t border-gray-100 pt-12">
        <div className="sm:flex sm:items-center sm:justify-between">
          ...
          <p className="mt-8 text-xs text-gray-500 sm:mt-0">
            &copy; 2025. Dyvos. All rights reserved.
          </p>
        </div>
      </div>
    </div>
